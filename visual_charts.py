...
def render_hpi_gauge(hpi_value: float, theme_mode: str = "Dark"):
    ...
    # Gauge angles (from pi to 0 radians)
    # 0 to 30 HPI -> pi to 2*pi/3 (Safe)
    # 30 to 70 HPI -> 2*pi/3 to pi/3 (Moderate)
    # 70 to 100+ HPI -> pi/3 to 0 (Hazard)
...
def render_metal_radar_chart(metals: dict, standards: dict, theme_mode: str = "Dark"):
    ...
    # Normalized ratio (concentration / permissible limit)
    # Ratio > 1.0 means exceeding BIS standard
